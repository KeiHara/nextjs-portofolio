...
const SideBar = () => {
  ...
  return (
    <div
      className={`fixed z-10 m-0  flex h-full w-20 flex-col bg-neutral-200 py-2 shadow-lg dark:bg-zinc-800 dark:text-white  sm:top-2/4 sm:h-[500px] sm:max-h-[50vh] sm:-translate-y-2/4  sm:rounded-2xl ${
        !onLeft
