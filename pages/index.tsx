      ...
      <div className="m-4">
        ...
        <div className="mt-4 flex flex-col">
          ...
          <p className="text-justify tracking-wide dark:text-white">
            Keisuke is a penultimate student studying a Bachelor of Science at
            the University of Auckland, majoring in Computer Science. He is
            passionate about taking on opportunities to improve his web
            development skills actively. He is currently working as a Frontend
            engineer / Mobile app developer at{' '}
            <a
        ...
        <div className="mt-4 flex flex-col">
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-4">
            ...
            <p className="dark:text-white">
              Working as a Front engineer at University of Auckland helping a
